...
; Schema: 0
          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpMemberName %Uniforms 0 "width"
               OpMemberName %Uniforms 1 "height"
               OpMemberName %Uniforms 2 "pad0"
               OpMemberName %Uniforms 3 "pad1"
               OpName %u "u"
               OpName %h "h"
               OpName %idx "idx"
               OpName %base "base"
               OpName %OutBuf "OutBuf"
               OpMemberName %OutBuf 0 "out_data"
               OpName %_ ""
               OpName %InBuf "InBuf"
               OpMemberName %InBuf 0 "in_data"
               OpName %__0 ""
...
%_ptr_StorageBuffer_Uniforms = OpTypePointer StorageBuffer %Uniforms
          %u = OpVariable %_ptr_StorageBuffer_Uniforms StorageBuffer
...
%_ptr_StorageBuffer_OutBuf = OpTypePointer StorageBuffer %OutBuf
          %_ = OpVariable %_ptr_StorageBuffer_OutBuf StorageBuffer
...
%_ptr_StorageBuffer_InBuf = OpTypePointer StorageBuffer %InBuf
        %__0 = OpVariable %_ptr_StorageBuffer_InBuf StorageBuffer
...
%gl_WorkGroupSize = OpConstantComposite %v3uint %uint_16 %uint_16 %uint_1
       ...
       %base = OpVariable %_ptr_Function_int Function
         ...
         %19 = OpLoad %uint %18
               OpStore %y %19
         %29 = OpAccessChain %_ptr_StorageBuffer_float %u %int_0
         %30 = OpLoad %float %29
         %31 = OpConvertFToS %int %30
               OpStore %w %31
         %34 = OpAccessChain %_ptr_StorageBuffer_float %u %int_1
         %35 = OpLoad %float %34
         ...
         %76 = OpAccessChain %_ptr_StorageBuffer_float %__0 %int_0 %75
         %77 = OpLoad %float %76
         %78 = OpAccessChain %_ptr_StorageBuffer_float %_ %int_0 %69
               OpStore %78 %77
         %79 = OpLoad %int %w
         %80 = OpLoad %int %h
         %81 = OpIMul %int %79 %80
         ...
         %87 = OpAccessChain %_ptr_StorageBuffer_float %__0 %int_0 %86
         %88 = OpLoad %float %87
         %89 = OpAccessChain %_ptr_StorageBuffer_float %_ %int_0 %84
               OpStore %89 %88
         %90 = OpLoad %int %w
         %91 = OpLoad %int %h
         %92 = OpIMul %int %90 %91
         ...
         %99 = OpAccessChain %_ptr_StorageBuffer_float %__0 %int_0 %98
        %100 = OpLoad %float %99
        %101 = OpAccessChain %_ptr_StorageBuffer_float %_ %int_0 %96
               OpStore %101 %100
        %102 = OpLoad %int %w
        %103 = OpLoad %int %h
        ...
        %111 = OpAccessChain %_ptr_StorageBuffer_float %__0 %int_0 %110
        %112 = OpLoad %float %111
        %113 = OpAccessChain %_ptr_StorageBuffer_float %_ %int_0 %108
               OpStore %113 %112
               OpReturn
               OpFunctionEnd
